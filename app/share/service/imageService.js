angular.module('app.share')
	.service('ImageService', function(storage, config, FileUploader){
		/**
		 * Get image uploader
		 */
		this.getUploader = function(url, opt) {
			opt = opt || {};
		 ...
		 */
		this.assignUploaderEvents = function(uploader, images, queueLimit, onFail) {
