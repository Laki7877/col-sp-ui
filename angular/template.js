 ...
 * Sat Feb 27 2016 21:29:49 GMT+0700 (SE Asia Standard Time)
 */
module.exports = ["$templateCache", function($templateCache) {  'use strict';
  ...
  $templateCache.put('common/modalChangePassword',
    ...
    "              }\r" +
    "\n" +
    "              }\"><input class=form-control type={{$parent.inputType}} name=Password ng-model=formData.Password ng-class=\"{ 'has-error' : isInvalid(form.Password) || (form.$pristine && formData.error) }\" required></div><div ng-template=common/input/password ng-template-options=\"{\r" +
    "\n" +
