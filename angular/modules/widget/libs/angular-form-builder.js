(function() {
  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', function($scope, $injector, $http) {
      var $builder;
      ...
      $scope.setupScope = function(formObject) {
        ...
        $scope.$watch('[label, description, placeholder, required, options, validation, url, size, borderSize, borderColor, boxBackground, boxColor, imgL, imgR, paddingFBLR, imgCol3_1, imgCol3_2, imgCol3_3, imgCol3_4, imgHeader]', function() {
          ...
          // Add Other
          formObject.url = $scope.url;
          formObject.size = $scope.size;
          formObject.borderSize = $scope.borderSize;
          formObject.borderColor = $scope.borderColor;
          formObject.boxColor = $scope.boxColor;
          formObject.boxBackground = $scope.boxBackground;
          formObject.imgL = $scope.imgL;
          formObject.imgR = $scope.imgR;
          formObject.paddingFBLR = $scope.paddingFBLR;
          formObject.imgCol3_1 = $scope.imgCol3_1;
          formObject.imgCol3_2 = $scope.imgCol3_2;
          formObject.imgCol3_3 = $scope.imgCol3_3;
          formObject.imgCol3_4 = $scope.imgCol3_4;
          formObject.imgHeader = $scope.imgHeader;
      ...
      return $scope.data = {
        ...
        backup: function() {
          ...
          return this.model = {
            ...
            boxBackground: $scope.boxBackground,
            imgL: $scope.imgL,
            imgR: $scope.imgR,
            paddingFBLR: $scope.paddingFBLR,
            imgCol3_1: $scope.imgCol3_1,
            imgCol3_2: $scope.imgCol3_2,
            imgCol3_3: $scope.imgCol3_3,
            imgCol3_4: $scope.imgCol3_4,
            imgHeader: $scope.imgHeader
          };
        },
        rollback: function() {
          ...
          $scope.url = this.model.url;
          $scope.size = this.model.size;
          $scope.borderSize = this.model.borderSize;
          $scope.borderColor = this.model.borderColor;
          $scope.boxColor = this.model.boxColor;
          $scope.boxBackground = this.model.boxBackground;
          $scope.imgL = this.model.imgL;
          $scope.imgR = this.model.imgR;
          $scope.paddingFBLR = this.model.paddingFBLR;
          $scope.imgCol3_1 = this.model.imgCol3_1;
          $scope.imgCol3_2 = this.model.imgCol3_2;
          $scope.imgCol3_3 = this.model.imgCol3_3;
          $scope.imgCol3_4 = this.model.imgCol3_4;
          $scope.imgHeader = this.model.imgHeader;
...
(function() {
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    ...
    this.convertComponent = function(name, component) {
      var result, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref23;
      result = {
        name: name,
        ...
        // Add Other
        url: (_ref10 = component.url) !=null ? _ref10 : '',
        size: (_ref11 = component.size) !=null ? _ref11 : '',
        borderSize: (_ref12 = component.borderSize) !=null ? _ref12 : '',
        borderColor: (_ref13 = component.borderColor) !=null ? _ref13 : '',
        boxColor: (_ref14 = component.boxColor) != null ? _ref14 : '',
        boxBackground: (_ref15 = component.boxBackground) !=null ? _ref15 : '',
        imgL: (_ref16 = component.imgL) !=null ? _ref16 : '',
        imgR: (_ref17 = component.imgR) !=null ? _ref17 : '',
        paddingFBLR: (_ref18 = component.paddingFBLR) !=null ? _ref18 : '',
        imgCol3_1: (_ref19 = component.imgCol3_1) !=null ? _ref19 : '',
        imgCol3_2: (_ref20 = component.imgCol3_2) !=null ? _ref20 : '',
        imgCol3_3: (_ref21 = component.imgCol3_3) !=null ? _ref21 : '',
        imgCol3_4: (_ref22 = component.imgCol3_4) !=null ? _ref22 : '',
        imgHeader: (_ref23 = component.imgHeader) !=null ? _ref23 : '',
    ...
    this.convertFormObject = function(name, formObject) {
      var component, result, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref20, _ref21, _ref22, _ref23;
      if (formObject == null) {
        formObject = {};
      }
      ...
      result = {
        ...
        // Add Other _ref
        url: (_ref10 = formObject.url) !=null ? _ref10 : component.url,
        size: (_ref11 = formObject.size) !=null ? _ref11 : component.size,
        borderSize: (_ref12 = formObject.borderSize) !=null ? _ref12 : component.borderSize,
        borderColor: (_ref13 = formObject.borderColor) !=null ? _ref13 : component.borderColor,
        boxColor: (_ref14 = formObject.boxColor) !=null ? _ref14 : component.boxColor,
        boxBackground: (_ref15 = formObject.boxBackground) !=null ? _ref15 : component.boxBackground,
        imgL: (_ref16 = formObject.imgL) !=null ? _ref16 : component.imgL,
        imgR: (_ref17 = formObject.imgR) !=null ? _ref17 : component.imgR,
        paddingFBLR: (_ref18 = formObject.paddingFBLR) !=null ? _ref18 : component.paddingFBLR,
        imgCol3_1: (_ref19 = formObject.imgCol3_1) !=null ? _ref19 : component.imgCol3_1,
        imgCol3_2: (_ref20 = formObject.imgCol3_2) !=null ? _ref20 : component.imgCol3_2,
        imgCol3_3: (_ref21 = formObject.imgCol3_3) !=null ? _ref21 : component.imgCol3_3,
        imgCol3_4: (_ref22 = formObject.imgCol3_4) !=null ? _ref22 : component.imgCol3_4,
        imgHeader: (_ref23 = formObject.imgHeader) !=null ? _ref23 : component.imgHeader
      };
      return result;
    };
