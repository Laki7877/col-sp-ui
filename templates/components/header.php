<div class="header container-fluid">
    ...
    <span class="header-font-detail">
        ...
        <i class="fa fa-angle-down" data-container="body" data-html="true" data-toggle="popover" data-placement="bottom" data-content="
                  ...
                  <div class='text-nowrap'><a href='#' data-toggle='modal' data-target='#change-password'>Change Password</a></div>
    ...
    <? $this->insert('components/modal-change-password', ['id' => 'change-password', 'header' => 'Change password']) ?>
