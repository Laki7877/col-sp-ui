			...
			<div class="modal-body confirmation-modal no-margin">
				<div class="row">
					...
					<div class="confirmation-action no-margin">
						...
						<button type="button" class="btn btn-blue" data-toggle="modal" ng-click="confirmExportProductCollection()" data-target="#export-product-collection-progressing">Continue</button>
					</div> <!-- end .col-xs-12 -->
				</div> <!-- end .row -->
			</div> <!-- end .modal-body -->
