			...
			<div class="modal-body confirmation-modal">
				<div class="row">
					...
					<div class="confirmation-action">
						<button class="col-xs-6 btn btn-white" ng-click="<?= $exit ?>">Don't Save and Exit</button>
						<button class="col-xs-6 btn btn-blue" type="button" ng-click="<?= $save ?>">Save and Exit</button>
					</div> <!-- end .col-xs-12 -->
				</div> <!-- end .row -->
			</div> <!-- end .modal-body -->
