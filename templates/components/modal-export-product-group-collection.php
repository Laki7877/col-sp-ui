			...
			<div class="modal-body confirmation-modal no-margin">
				<div class="row">
					<div class="col-xs-12 margin-bottom-30">
						<h2 class="font-size-20 text-centerx text-normal margin-bottom-20">Export Group Collection</h2>
					...
					<div class="confirmation-action no-margin">
						...
						<button type="button" class="btn btn-blue" data-toggle="modal" ng-click="confirmExportProductCollection()" data-target="#export-product-group-collection-progressing">Continue</button>
					</div> <!-- end .col-xs-12 -->
				</div> <!-- end .row -->
			</div> <!-- end .modal-body -->
