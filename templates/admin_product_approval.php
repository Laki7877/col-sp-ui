<?php $this->layout('layouts/page-with-sidebar-admin', ['title' => 'Admin - Product Approval']) ?>

<?php $this->start('page-body') ?>

<div ng-controller="AdminProductApprovalListCtrl">
   <nc-alert nc-model="alert"></nc-alert>
   <nc-page-title nc-title="Product Approval" icon="fa-tag">
   </nc-page-title>
<div>
    <div class="row search-section-wrapper">
          <nc-bulk nc-model="bulkContainer" nc-bulk-fn="bulks" nc-bulk-track-by="ProductId"></nc-bulk>
		  <nc-search nc-model="params.searchText" nc-search-placeholder="'Search for Product Name or Tag'"></nc-search>
