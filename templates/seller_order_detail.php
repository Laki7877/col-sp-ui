        ...
        <div class="col-xs-6 no-padding">
          ...
          <div class="color-dark-grey margin-top-5">
            ...
            <div>Carrier: 
              ...
              <input ng-if="getState() >= 3 && merchantFleet()" class="form-control" type="text" ng-model="formData.Carrier" />
            </div>
            <div>Tracking Number: 
              <span ng-if="!(getState() >= 3 && merchantFleet())">{{formData.TrackingNumber}}</span>
              <input ng-if="getState() >= 3 && merchantFleet()" class="form-control" type="text" ng-model="formData.TrackingNumber" />
            </div>       
        </div>
