  ...
  <div ng-controller="SellerOrderAddCtrl" ng-init="init(<?= $params ?>)">
    ...
    <nc-page-title nc-title="{{title}}" link="{{url}}" icon="fa-inbox">
      <span class="float-right page-header-action">
        ...
        <button ng-if="getState() == 1" class="btn btn-blue btn-width-xl margin-left-10" ng-if="$root.permit(31)" ng-click="acknowledge()">Acknowledge</button>
        <button ng-if="getState() == 2" class="btn btn-blue btn-width-xxl margin-left-10" ng-if="$root.permit(31)" ng-click="readyShip()">Ready to Ship</button>
        <button ng-if="getState() >= 3" class="btn btn-blue btn-width-xl margin-left-10" ng-if="$root.permit(31)" ng-click="save()">Save</button>
        <button ng-if="getState() == 3 && merchantFleet()" class="btn btn-blue btn-width-xl margin-left-10" ng-if="$root.permit(31)" ng-click="delivered()">Delivered</button>
      </span>
    </nc-page-title>
    <div>
        ...
        <div class="add-product-form-action main-form-action full-width-row">
          <div class="container-fluid">
            <span class="float-right">
              ...
              <button ng-if="getState() == 1" class="btn btn-blue btn-width-xl" ng-if="$root.permit(31)" ng-click="acknowledge()">Acknowledge</button>
              <button ng-if="getState() == 2" class="btn btn-blue btn-width-xxl" ng-if="$root.permit(31)" ng-click="readyShip()">Ready to Ship</button>
              <button ng-if="getState() >= 3" class="btn btn-blue btn-width-xl" ng-if="$root.permit(31)" ng-click="save()">Save</button>
            </span>
          </div>
        </div>
      </form>
