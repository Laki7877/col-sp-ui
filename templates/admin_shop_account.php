...
<?php $this->start('page-body') ?>
  <div>
    <? $this->insert('components/page-title-with-one-button', ['text' => 'Shop Accounts','button' => 'Create New Seller Shop', 'button_class' => 'btn-width-xxxl', 'link' => '?p=admin_add_attribute']) ?>
