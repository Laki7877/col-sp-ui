...
<?php $this->start('page-body') ?>
  <div>
    <? $this->insert('components/page-title-with-one-button', ['text' => 'Shop Accounts','button' => 'Create New Seller Shop', 'button_class' => 'btn-width-xxxl', 'link' => '?p=admin_add_shop_account']) ?>
      ...
      <table class="table table-curved table-border-none">
        <thead>
          <tr class="table-head">
            ...
            <th>
              <a class="header-link" href="#"><span>Shop Name</span></a>
