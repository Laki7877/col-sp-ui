...
<?php
	    $this->layout('layouts/page-with-sidebar', ['title' => 'Seller Portal - CMS Category'])
?>

<?php $this->start('page-body') ?>
	<div ng-controller="SellerCMSCategoryListCtrl">
      <nc-alert nc-model="alert"></nc-alert>
       <nc-page-title nc-title="CMS Categories">
            <a ng-href="/cms/category/create" class="btn margin-right-10 ng-scope btn-primary btn-width-xl" ng-disabled="CMSadd">
		        ...
		        <tbody>
		            <tr ng-repeat="row in list.data">
	                    <td class="checkbox-column"><nc-bulk-checkbox nc-model="row"></nc-bulk-checkbox></td>
			                <td class="column-text-ellipsis" nc-link="/cms/category/{{row.CMSCategoryId}}">
