								...
								<div class="form-section">
									...
									<div class="form-section-content">
										<div nc-template="common/input/form-group-with-label"
											...
											<div type="text" class="width-100-percent form-control get_file" ng-delegate="f"><span ng-if="uploader.queue.length == 0" class="color-grey">Browse file to upload</span><span ng-if="uploader.queue.length > 0">{{ uploader.queue[uploader.queue.length-1].file.name }}</span></div>
