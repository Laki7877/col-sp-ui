...
<?php $this->start('page-body') ?>
  <div>
    <? $this->insert('components/page-title-with-one-button', ['text' => 'Shop Types','button' => 'Create New Shop Type', 'button_class' => 'btn-width-xxxl', 'link' => '?p=admin_add_shop_account']) ?>
