...
<?php $this->start('page-body') ?>
	<div class="local-category-page" ng-controller="Buy1Get1ImportCtrl">
		<?php $this->insert('components/alert-text', ['close' => true, 'color' => 'green', 'text' => 'Successfully Import Collections. <a class="color-black text-underline">View Buy1 Get 1 List</a>']) ?>
		...
		<?php $this->insert('components/page-title-breadcrumb-border', ['text' => 'Buy1 Get 1/Import Item']) ?>

		<div>
			<form class="ah-form sticky-mainform-action">
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane margin-top-20 active" id="more_option">
						<?php $this->insert('partials/import-buy1get1-content') ?>
					</div>
				</div>
			</form>
		</div>
