...
<?php $this->start('page-body') ?>
	<div ng-controller="AdminSumProductOnWebCtrl">
		<nc-page-title nc-title="Product Onweb Summary" icon="fa-user">
    ...
    <table class="table table-curved">
      <thead>
        <tr class="table-head">
          ...
          <th nc-sort="OnWeb">Onweb</th>
          <th nc-sort="NotOnWeb">Not Onweb</th>
      ...
      <tbody>
        <tr ng-repeat="row in list.data" ng-show="list.data.length > '0'">
          ...
          <td class="width_150">{{row.CreatedDate}}</td>
          <td class="width_100">{{row.Category}}</td>
          <td class="width_100">{{row.Seller}}</td>
          <td class="width_100">{{row.OnWeb}}</td>
          <td class="width_100">{{row.NotOnWeb}}</td>
