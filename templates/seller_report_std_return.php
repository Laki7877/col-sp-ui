    ...
    <div class="form-section">
      ...
      <div class="form-section-content">
        <form name="form" class="ah-form" novalidate="">
          ...
          <!--Time Of Order Date-->
          <div nc-template="common/input/form-group-with-label-multiple" nc-template-form="form.CreatedDate" nc-label="Return Order Date" nc-template-options-path="searchForm/CreatedDate">
