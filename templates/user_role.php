...
<?php $this->start('page-body') ?>
  <div>
    <? $this->insert('components/page-title-with-one-button', ['text' => 'User Roles','button' => 'Create New Role', 'button_class' => 'btn-width-xxxl', 'link' => '?p=user_add_role']) ?>
      ...
      <table class="table table-curved table-border-none">
        <thead>
          <tr class="table-head">
            ...
            <th>
              <a class="header-link" href="#"><span># of Users</span></a>
              <!-- <i class="fa fa-caret-up color-grey"> -->
            </th>
            <th>
              Action
