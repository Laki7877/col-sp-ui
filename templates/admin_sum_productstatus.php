...
<?php $this->start('page-body') ?>
	<div ng-controller="AdminSumProductStatusCtrl">
		<nc-page-title nc-title="Product Status Summary" icon="fa-user">
    ...
    <table class="table table-curved">
      <thead>
        <tr class="table-head">
          ...
          <th nc-sort="ReadyForApproved">Ready For Approved</th>
      ...
      <tbody>
        <tr ng-repeat="row in list.data" ng-show="list.data.length > '0'">
          ...
          <td class="width_100">{{row.CreatedDate}}</td>
          ...
          <td class="width_100">{{row.ReadyForApproved}}</td>
