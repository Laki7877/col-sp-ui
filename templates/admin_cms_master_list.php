<?php $this->layout('layouts/page-with-sidebar', ['title' => 'CMS Master - All']) ?>
      ...
      <table class="table table-curved">
          <thead>
              <tr class="table-head">
                  ...
                  <th nc-sort="ProductNameEn">CMS Master Name</th>
                  <th>Tag</th>
          ...
          <tbody>
              <tr ng-repeat="row in list.data">
                  ...
                  <td class="column-text-ellipsis">
                    <div><a href="/cms/master/{{ row.CMSMasterId }}">{{ row.CMSMasterNameEN || '(Untitled Master)' }}</a></div>
