<div id="create_buy1_get1_get">
<!-- <div id="create_cms_category_item"> -->

  <div class="row">
    <div class="col-xs-12">
      <button class="btn btn-sm btn-primary" ng-click="addProductGetItem()" ng-hide="sumProductSelected() > 0">
...
<!-- modal temaplate -->
<script type="text/ng-template" id="templates/promotion-buy1get1-get-item.html">
