        ...
        <div class="col-xs-12">
            <div class="form-section">
                ...
                <div class="form-section-content">
                    <div nc-template="common/input/form-group-with-label" nc-label="Category Name(TH)" nc-template-form="formData.NameTH" nc-template-options-path="CMSCategoryForm/NameTH">
                        <input class="form-control width-field-large" name="NameTH" ng-model="formData.NameTH" ng-pattern="/^[^<>]+$/" maxlength="300" required />
                    </div>

                    <div nc-template="common/input/form-group-with-label" nc-label="Category Name(EN)" nc-template-form="formData.NameEN" nc-template-options-path="CMSCategoryForm/NameEN">
                        <input class="form-control width-field-large" name="NameEN" ng-model="formData.NameEN" ng-pattern="/^[^<>]+$/" maxlength="300" required />
                    </div>
                    <!--<div nc-template="common/input/form-group-with-label" nc-label="Bank Name TH" nc-template-form="formData.BankNameTH" nc-template-options-path="CMSCategoryForm/BankNameTH">
