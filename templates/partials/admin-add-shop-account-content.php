		...
		<div class="col-xs-12">
			<div class="form-section">
				...
				<div class="form-section-content">
					...
					<?php $this->insert('components/forms/input-text-with-label', ["label" => "Shop Name", "label_class" => "required"]) ?>
					<?php $this->insert('components/forms/dropdown-with-label', ["label" => "Shop Type", "label_class" => "required", "options" => ["Select Shop Type", "Type 1"]]) ?>
					<?php $this->insert('components/forms/link-action', ['text' => 'Add New Shop Type', 'link' => '/?p=admin_add_shop_type']) ?>
					<?php $this->insert('components/forms/dropdown-with-label', ["label" => "Shop Status", "options" => ["Active", "Inactive"]]) ?>
					<?php $this->insert('components/forms/input-text-with-label', ["label" => "Comission(%)", "label_class" => "required", "size" => "small"]) ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="col-xs-12">
			<div class="form-section">
				...
				<div class="form-section-content">
					...
					<?php $this->insert('components/forms/input-text-with-label', ["label" => "Position", "label_class" => "required"]) ?>
					...
					<?php $this->insert('components/forms/password-field', ["label" => "Password", "label_class" => "required"]) ?>
