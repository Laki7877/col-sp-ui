        ...
        <div class="col-xs-12">
            <div class="form-section">
                ...
                <div class="form-section-content">
                    ...
                    <div ng-show="formData.Conditions.Order[0].Type == 'PriceGT'" ng-init="formData.Conditions.Order[0].Type = 'None'" nc-template="common/input/form-group-with-label" nc-label="Price" nc-template-options-path="couponForm/ConditionValue">
            ...
            <div class="form-section">
                ...
                <div class="form-section-content">
                    <div nc-template="common/input/form-group-with-label" nc-label="Criteria">
                        <div class="ah-select2-dropdown">
                            <select ng-init="formData.Conditions.FilterBy[0].Type = 'None'" ng-model="formData.Conditions.FilterBy[0].Type" class="form-control" required>
                    ...
                    <div nc-template="common/input/form-group-with-label" nc-template-options-path="couponForm/FilterByValue" nc-label="Include" ng-show="formData.Conditions.FilterBy[0].Type != 'None'">
                        <ui-select multiple ng-model="formData.Conditions.FilterBy[0].Value" ng-init="formData.Conditions.FilterBy[0].Value = []" ng-if="formData.Conditions.FilterBy[0].Type == 'Brand'">
                            <ui-select-match placeholder="Search by Brand...">
                                <span ng-bind="$item.BrandNameEn"></span>
                            </ui-select-match>
                            <ui-select-choices ui-disable-choice="item.disabled" refresh-delay="1000" refresh="refreshBrands($select.search)" repeat="item in (dataSet.Brands)  | filter : $select.search track by item.BrandId">
                                <span>{{ item.BrandNameEn }} </span>
                                <span ng-if="item.BrandNameTh">/ {{ item.BrandNameTh }}</span>
                            </ui-select-choices>
                        </ui-select>
                        <ui-select multiple tagging tagging-label="(new)" ng-init="formData.Conditions.FilterBy[0].Value = []" ng-model="formData.Conditions.FilterBy[0].Value" ng-if="formData.Conditions.FilterBy[0].Type == 'Email'">
                        ...
                        <ui-select multiple ng-model="formData.Conditions.FilterBy[0].Value" ng-init="formData.Conditions.FilterBy[0].Value = []" ng-if="formData.Conditions.FilterBy[0].Type == 'Shop'">
            ...
            <div class="form-section">
                ...
                <div class="form-section-content">
                    ...
                    <div nc-template="common/input/form-group-with-label" nc-template-options-path="couponForm/IncludeProducts" nc-label="Products">
