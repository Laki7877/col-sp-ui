      ...
      <div class="form-section">
        ...
        <div class="form-section-content">
          <div class="form-group">
            <div class="col-sm-12">
              <button ng-click="addCategoryItem()" class="btn btn-primary">Add Category</button>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <table class="table table-bordered table-striped">
                ...
                <tbody id="sortable">
                  <tr ng-repeat="item in Schedule.CategoryList | orderBy : 'Sequence'">
                    <td>
                    ...
                    <td>
                      <button class="btn btn-sm btn-default" ng-disabled="$index == 0 || (Schedule.CategoryList.length == 0)"
                          ng-click="moveUp($index, $index - 1)">
                        <i class="fa fa-chevron-up"></i>
                      </button>
                      <button class="btn btn-sm btn-default" ng-disabled="$index == (Schedule.CategoryList.length - 1) || (Schedule.CategoryList.length == 0)"
