...
<body>
    ...
    <p><b>We are sorry</b>. <ins>An unexpected exception has occurred.</ins>
    </p>
    <p>The following error was logged <pre><?=htmlspecialchars(base64_decode($_GET['e']))?></pre>
    <ins>Kindly pass this along to our admin. Thanks!</ins>
    </p>
