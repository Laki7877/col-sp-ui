										...
										<div class="form-section-content">
						                    ...
						                    <div class="margin-top-10" 
						                    	...
						                    	nc-template-options-path="addShopAccountForm/BankName">
						                           <input class="form-control" name="BankName" type="text" ng-model="formData.BankName" disabled required />
						                    </div>
						                    <div nc-template="common/input/form-group-with-label"
						                    	...
						                    	nc-template-options-path="addShopAccountForm/BankAccountNumber">
						                           <input class="form-control" name="BankAccountNumber" type="text" ng-model="formData.BankAccountNumber" disabled required/>
						                    </div>
						                    <div nc-template="common/input/form-group-with-label"
						                    	...
						                    	nc-template-options-path="addShopAccountForm/BankAccountName">
						                           <input class="form-control" name="BankAccountName" type="text" ng-model="formData.BankAccountName" disabled required/>
						                    </div>
										</div>
									</div>
								</div>
